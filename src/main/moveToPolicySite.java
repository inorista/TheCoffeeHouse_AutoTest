...
public class moveToPolicySite {
	...
	@Test(priority = 0)
	public void clickDropdownStep() throws IOException {
		objHomePage = new homePage(driver, wait);
		objHomePage.goToPolicySite();
	}
	
	@Test(priority = 1)
	public void checkMovedPolicySite() {
		objHomePage.checkCurrentSitePolicy(url);
	}
