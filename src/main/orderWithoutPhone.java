...
public class orderWithoutPhone {
    ...
    public void setUpData() throws IOException {
		...
		///////DATA FROM EXCEL
		cateName = sheet.getRow(3).getCell(0).getStringCellValue();
		productName = sheet.getRow(3).getCell(1).getStringCellValue();
		address = sheet.getRow(3).getCell(2).getStringCellValue();
		name = sheet.getRow(3).getCell(3).getStringCellValue();
		phone = sheet.getRow(3).getCell(4).getStringCellValue();
	}
