...
public class orderSuccess {
    ...
    public void setUpData() throws IOException {
		...
		///////DATA FROM EXCEL
		cateName = sheet.getRow(1).getCell(0).getStringCellValue();
		productName = sheet.getRow(1).getCell(1).getStringCellValue();
		address = sheet.getRow(1).getCell(2).getStringCellValue();
		name = sheet.getRow(1).getCell(3).getStringCellValue();
		phone = sheet.getRow(1).getCell(4).getStringCellValue();
	}
